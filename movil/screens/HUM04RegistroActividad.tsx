...
export default function HUM04RegistroActividad({ navigation }: any) {
  const [seleccionada, setSeleccionada] = useState<string | null>(null);

  const handleContinuar = () => {
    navigation.navigate('HUM05');
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.titulo}>Paso 1/7</Text>
        </View>

        {/* Barra de progreso */}
        <View style={styles.progressContainer}>
          <View style={styles.progressBackground}>
            <View style={[styles.progressBar, { width: '14.28%' }]} />
          </View>
        </View>
        ...
        <Text style={styles.descripcion}>
          Selecciona la opcion que mejor describe tu rutina actual.
        </Text>
        ...
        {[
          {
            id: 'sedentario',
            titulo: 'Sedentario',
            desc: 'Poca o ninguna actividad fisica.',
            icon: '🛋',
          },
          {
            id: 'bajo',
            titulo: 'Bajo',
            desc: 'Caminar tareas domesticas, subir escaleras.',
            icon: '🚶',
          },
          {
            id: 'mediano',
            titulo: 'Mediano',
            desc: 'Deportes, gimnasio 1-2 veces por semana',
            icon: '🏃',
          },
          {
            id: 'alto',
            titulo: 'Alto',
            desc: 'Entrenamiento intenso, gimnasio 5-6 veces por semana',
            icon: '🏋',
          },
        ].map((opcion) => (
          <TouchableOpacity
